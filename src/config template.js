const config = {
    ...
    commands: {
        ...
        interval: 300, // How many seconds between refreshes for a appid (in seconds)
        webhook: "",
    ...
    users: {
        ownerId: 'your user id', // The bot owner ID, which is you.
        developers: ['your user id'] // The bot developers, remember to include your account ID with the other account IDs.
    },
